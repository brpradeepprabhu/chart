  ...
  template: `
        <ng-template ngFor let-col [ngForOf]="columns" let-lastCol="last">
            <th #headerCell [ngStyle]="col.style" [class]="col.styleClass" [style.display]="col.hidden ? 'none' : 'table-cell'" (click)="dt.sort($event,col)" [attr.colspan]="col.colspan" [attr.rowspan]="col.rowspan"
                ...
                <span class="ui-sortable-column-icon ui-filter-column" *ngIf="col.filter" (click)='col.filterVisibile=true;filterClick($event,col)' [ngClass]="col.filterColor"> <svg-icon class="svg-selected filterIcon" src="../../../../assets/svgicons/filter-selected.svg" *ngIf="col.svgPath"></svg-icon><svg-icon class="filterIcon" src="../../../../assets/svgicons/filter.svg" *ngIf="!col.svgPath"></svg-icon></span>
                ...
                *ngIf="dt.groupField && dt.rowGroupMode=='subheader' && (rowIndex === 0||(dt.resolveFieldData(rowData,dt.groupField) !== dt.resolveFieldData(dt.dataToRender[rowIndex - 1], dt.groupField)))"
                ...
                <td [attr.colspan]="dt.visibleColumns().length">
                    <a href="#" *ngIf="dt.expandableRowGroups" (click)="dt.toggleRowGroup($event,rowData)">                    
                        <svg-icon class="sorticons" src="../../../../assets/svgicons/directional-down.svg" *ngIf= "dt.isRowGroupExpanded(rowData)"></svg-icon>
                        <svg-icon class="sorticons" src="../../../../assets/svgicons/next.svg" *ngIf= "!dt.isRowGroupExpanded(rowData)"></svg-icon>
                    </a>
...
@NgModule({
  imports: [CommonModule, AngularSvgIconModule, CalendarModule, SharedModule, PaginatorModule, FormsModule, DropdownModule, ButtonModule, MultiSelectModule],
